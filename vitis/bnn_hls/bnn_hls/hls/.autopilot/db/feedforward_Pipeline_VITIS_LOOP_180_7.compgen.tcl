...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer3_activations_address0 { O 4 vector } layer3_activations_ce0 { O 1 bit } layer3_activations_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TVALID { O 1 bit } output_stream_TDEST { O 8 vector } } \
} "
} else {
