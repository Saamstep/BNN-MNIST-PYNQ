set moduleName feedforward_Pipeline_VITIS_LOOP_148_7
set isTopModule 0
...
set cdfgNum 13
set C_modelName {feedforward_Pipeline_VITIS_LOOP_148_7}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict layer3_activations { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ layer3_activations int 32 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ layer3_activations_q0 sc_in sc_lv 32 signal 0 } 
	...
	{ output_stream_TUSER sc_out sc_lv 2 signal 4 } 
	{ output_stream_TLAST sc_out sc_lv 1 signal 5 } 
	{ output_stream_TID sc_out sc_lv 5 signal 6 } 
	{ output_stream_TDEST sc_out sc_lv 8 signal 7 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "feedforward_Pipeline_VITIS_LOOP_148_7",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	layer3_activations { ap_memory {  { layer3_activations_address0 mem_address 1 6 }  { layer3_activations_ce0 mem_ce 1 1 }  { layer3_activations_q0 mem_dout 0 32 } } }
	...
	output_stream_V_dest_V { axis {  { output_stream_TVALID out_vld 1 1 }  { output_stream_TDEST out_data 1 8 } } }
}
