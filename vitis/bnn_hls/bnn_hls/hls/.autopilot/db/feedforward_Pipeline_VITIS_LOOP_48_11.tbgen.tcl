set moduleName feedforward_Pipeline_VITIS_LOOP_48_11
set isTopModule 0
...
set cdfgNum 13
set C_modelName {feedforward_Pipeline_VITIS_LOOP_48_11}
...
set C_modelArgList {
	{ layer2_activations_6 int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ layer2_activations_5 int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ layer2_activations_4 int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ layer2_activations int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ a_1_reload int 32 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer2_activations_6", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer2_activations_5", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer2_activations_4", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ layer2_activations_6_address0 sc_out sc_lv 5 signal 0 } 
	{ layer2_activations_6_ce0 sc_out sc_logic 1 signal 0 } 
	{ layer2_activations_6_we0 sc_out sc_logic 1 signal 0 } 
	{ layer2_activations_6_d0 sc_out sc_lv 32 signal 0 } 
	{ layer2_activations_5_address0 sc_out sc_lv 5 signal 1 } 
	{ layer2_activations_5_ce0 sc_out sc_logic 1 signal 1 } 
	{ layer2_activations_5_we0 sc_out sc_logic 1 signal 1 } 
	{ layer2_activations_5_d0 sc_out sc_lv 32 signal 1 } 
	{ layer2_activations_4_address0 sc_out sc_lv 5 signal 2 } 
	{ layer2_activations_4_ce0 sc_out sc_logic 1 signal 2 } 
	{ layer2_activations_4_we0 sc_out sc_logic 1 signal 2 } 
	{ layer2_activations_4_d0 sc_out sc_lv 32 signal 2 } 
	{ layer2_activations_address0 sc_out sc_lv 5 signal 3 } 
	...
	{ a_1_reload sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "feedforward_Pipeline_VITIS_LOOP_48_11",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_activations_6", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "layer2_activations_5", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "layer2_activations_4", "Type" : "Memory", "Direction" : "O"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_257_7_7_1_1_U19", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	feedforward_Pipeline_VITIS_LOOP_48_11 {
		layer2_activations_6 {Type O LastRead -1 FirstWrite 1}
		layer2_activations_5 {Type O LastRead -1 FirstWrite 1}
		layer2_activations_4 {Type O LastRead -1 FirstWrite 1}
		layer2_activations {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	layer2_activations_6 { ap_memory {  { layer2_activations_6_address0 mem_address 1 5 }  { layer2_activations_6_ce0 mem_ce 1 1 }  { layer2_activations_6_we0 mem_we 1 1 }  { layer2_activations_6_d0 mem_din 1 32 } } }
	layer2_activations_5 { ap_memory {  { layer2_activations_5_address0 mem_address 1 5 }  { layer2_activations_5_ce0 mem_ce 1 1 }  { layer2_activations_5_we0 mem_we 1 1 }  { layer2_activations_5_d0 mem_din 1 32 } } }
	layer2_activations_4 { ap_memory {  { layer2_activations_4_address0 mem_address 1 5 }  { layer2_activations_4_ce0 mem_ce 1 1 }  { layer2_activations_4_we0 mem_we 1 1 }  { layer2_activations_4_d0 mem_din 1 32 } } }
	layer2_activations { ap_memory {  { layer2_activations_address0 mem_address 1 5 }  { layer2_activations_ce0 mem_ce 1 1 }  { layer2_activations_we0 mem_we 1 1 }  { layer2_activations_d0 mem_din 1 32 } } }
