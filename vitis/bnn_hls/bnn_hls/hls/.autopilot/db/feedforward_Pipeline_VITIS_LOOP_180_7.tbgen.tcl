set moduleName feedforward_Pipeline_VITIS_LOOP_180_7
set isTopModule 0
...
set cdfgNum 13
set C_modelName {feedforward_Pipeline_VITIS_LOOP_180_7}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict layer3_activations { MEM_WIDTH 32 MEM_SIZE 40 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ layer3_activations int 32 regular {array 10 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	layer3_activations { ap_memory {  { layer3_activations_address0 mem_address 1 4 }  { layer3_activations_ce0 mem_ce 1 1 }  { layer3_activations_q0 mem_dout 0 32 } } }
