...
entity feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_146_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_146_7 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln146_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal temp_last_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal temp_last_reg_163 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln146_fu_132_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_64 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal add_ln146_fu_126_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln146_fu_120_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_64 <= add_ln146_fu_126_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                temp_last_reg_163 <= temp_last_fu_137_p2;
            end if;
        end if;
    end process;
    ...
    add_ln146_fu_126_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln146_fu_120_p2)
    begin
        if (((icmp_ln146_fu_120_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln146_fu_120_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv4_A) else "0";
    layer3_activations_address0 <= zext_ln146_fu_132_p1(4 - 1 downto 0);
    ...
    output_stream_TLAST <= temp_last_reg_163;
    ...
    temp_last_fu_137_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv4_9) else "0";
    zext_ln146_fu_132_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_2),64));
end behav;
