...
entity feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_368_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_368_7 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln368_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal temp_last_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal temp_last_reg_223 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln368_fu_167_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_74 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal add_ln368_fu_161_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln368_fu_155_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_74 <= add_ln368_fu_161_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                temp_last_reg_223 <= temp_last_fu_172_p2;
            end if;
        end if;
    end process;
    ...
    add_ln368_fu_161_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln368_fu_155_p2)
    begin
        if (((icmp_ln368_fu_155_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln368_fu_155_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_A) else "0";
    layer3_activations_address0 <= zext_ln368_fu_167_p1(4 - 1 downto 0);
    ...
    output_stream_TDATA <= layer3_activations_q0;
    ...
    output_stream_TDEST <= p_phi18_reload;
    output_stream_TID <= p_phi17_reload;
    output_stream_TKEEP <= p_phi_reload;
    output_stream_TLAST <= temp_last_reg_223;
    output_stream_TSTRB <= p_phi15_reload;
    output_stream_TUSER <= p_phi16_reload;
    ...
    temp_last_fu_172_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_9) else "0";
    zext_ln368_fu_167_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
