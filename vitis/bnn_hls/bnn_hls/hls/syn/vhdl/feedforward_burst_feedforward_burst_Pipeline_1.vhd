...
entity feedforward_burst_feedforward_burst_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of feedforward_burst_feedforward_burst_Pipeline_1 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond2814_fu_86_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal loop_index3_load_reg_125 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal loop_index3_load_reg_125_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    signal gmem_addr_read_reg_134 : STD_LOGIC_VECTOR (31 downto 0);
    signal loop_index3_cast_fu_109_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal loop_index3_fu_46 : STD_LOGIC_VECTOR (9 downto 0) := "0000000000";
    signal empty_fu_92_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index3_load : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond2814_fu_86_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index3_fu_46 <= empty_fu_92_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index3_fu_46 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                loop_index3_load_reg_125 <= ap_sig_allocacmp_loop_index3_load;
                loop_index3_load_reg_125_pp0_iter1_reg <= loop_index3_load_reg_125;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem_addr_read_reg_134 <= m_axi_gmem_0_RDATA;
            end if;
        end if;
    end process;
    ...
    X0_input_address0 <= loop_index3_cast_fu_109_p1(10 - 1 downto 0);
    X0_input_ce0 <= X0_input_ce0_local;

    X0_input_ce0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
    ...
    X0_input_d0 <= gmem_addr_read_reg_134;
    X0_input_we0 <= X0_input_we0_local;

    X0_input_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond2814_fu_86_p2)
    begin
        if (((exitcond2814_fu_86_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index3_load_assign_proc : process(ap_CS_fsm_pp0_stage0, loop_index3_fu_46, ap_loop_init, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index3_load <= ap_const_lv10_0;
        else 
            ap_sig_allocacmp_loop_index3_load <= loop_index3_fu_46;
        end if; 
    end process;

    empty_fu_92_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index3_load) + unsigned(ap_const_lv10_1));
    exitcond2814_fu_86_p2 <= "1" when (ap_sig_allocacmp_loop_index3_load = ap_const_lv10_310) else "0";
    ...
    loop_index3_cast_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_index3_load_reg_125_pp0_iter1_reg),64));
