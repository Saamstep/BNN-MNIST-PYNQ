...
module feedforward_feedforward_Pipeline_VITIS_LOOP_143_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln143_fu_132_p1;
reg   [3:0] i_fu_64;
wire   [3:0] add_ln143_fu_126_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln143_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln143_fu_120_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln143_fu_126_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
assign icmp_ln143_fu_120_p2 = ((ap_sig_allocacmp_i_3 == 4'd10) ? 1'b1 : 1'b0);

assign layer3_activations_address0 = zext_ln143_fu_132_p1;
...
assign temp_last_fu_137_p2 = ((ap_sig_allocacmp_i_3 == 4'd9) ? 1'b1 : 1'b0);

assign zext_ln143_fu_132_p1 = ap_sig_allocacmp_i_3;

endmodule //feedforward_feedforward_Pipeline_VITIS_LOOP_143_7
