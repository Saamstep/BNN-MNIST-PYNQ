...
module feedforward_burst_feedforward_burst_Pipeline_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] layer3_activations_load_reg_140;
wire   [63:0] loop_index_cast_fu_103_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [3:0] loop_index_fu_48;
wire   [3:0] empty_fu_97_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond2_fu_91_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_48 <= empty_fu_97_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_48 <= 4'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond2_fu_91_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign empty_fu_97_p2 = (ap_sig_allocacmp_loop_index_load + 4'd1);

assign exitcond2_fu_91_p2 = ((ap_sig_allocacmp_loop_index_load == 4'd10) ? 1'b1 : 1'b0);

assign layer3_activations_address0 = loop_index_cast_fu_103_p1;
...
assign m_axi_gmem_0_WDATA = layer3_activations_load_reg_140;
...
endmodule //feedforward_burst_feedforward_burst_Pipeline_11
