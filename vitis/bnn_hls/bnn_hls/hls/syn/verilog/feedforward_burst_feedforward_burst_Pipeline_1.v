...
module feedforward_burst_feedforward_burst_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond2814_fu_86_p2;
...
reg   [9:0] loop_index3_load_reg_125;
reg    ap_block_pp0_stage0_11001;
reg   [9:0] loop_index3_load_reg_125_pp0_iter1_reg;
reg   [31:0] gmem_addr_read_reg_134;
wire   [63:0] loop_index3_cast_fu_109_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [9:0] loop_index3_fu_46;
wire   [9:0] empty_fu_92_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond2814_fu_86_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index3_fu_46 <= empty_fu_92_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_fu_46 <= 10'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond2814_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign X0_input_address0 = loop_index3_cast_fu_109_p1;

assign X0_input_ce0 = X0_input_ce0_local;

assign X0_input_d0 = gmem_addr_read_reg_134;
...
assign empty_fu_92_p2 = (ap_sig_allocacmp_loop_index3_load + 10'd1);

assign exitcond2814_fu_86_p2 = ((ap_sig_allocacmp_loop_index3_load == 10'd784) ? 1'b1 : 1'b0);

assign loop_index3_cast_fu_109_p1 = loop_index3_load_reg_125_pp0_iter1_reg;
...
endmodule //feedforward_burst_feedforward_burst_Pipeline_1
