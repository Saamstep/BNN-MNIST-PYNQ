...
module feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_146_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] temp_last_fu_137_p2;
reg   [0:0] temp_last_reg_163;
wire   [63:0] zext_ln146_fu_132_p1;
reg   [3:0] i_fu_64;
wire   [3:0] add_ln146_fu_126_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln146_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln146_fu_120_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln146_fu_126_p2 = (ap_sig_allocacmp_i_2 + 4'd1);
...
assign icmp_ln146_fu_120_p2 = ((ap_sig_allocacmp_i_2 == 4'd10) ? 1'b1 : 1'b0);

assign layer3_activations_address0 = zext_ln146_fu_132_p1;
...
assign output_stream_TLAST = temp_last_reg_163;

assign output_stream_TSTRB = 4'd15;

assign output_stream_TUSER = 'bx;

assign temp_last_fu_137_p2 = ((ap_sig_allocacmp_i_2 == 4'd9) ? 1'b1 : 1'b0);

assign zext_ln146_fu_132_p1 = ap_sig_allocacmp_i_2;

endmodule //feedforward_stream_feedforward_stream_Pipeline_VITIS_LOOP_146_7
