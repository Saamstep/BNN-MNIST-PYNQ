...
module feedforward_feedforward_Pipeline_VITIS_LOOP_103_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [8:0] layer1_activations_2_address1;
...
output  [8:0] layer1_activations_address1;
...
wire   [0:0] icmp_ln103_fu_82_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [8:0] layer1_activations_addr_reg_150;
reg   [8:0] layer1_activations_addr_reg_150_pp0_iter1_reg;
reg   [8:0] layer1_activations_2_addr_reg_156;
reg   [8:0] layer1_activations_2_addr_reg_156_pp0_iter1_reg;
reg   [31:0] layer1_activations_load_reg_162;
reg   [31:0] layer1_activations_2_load_reg_167;
wire   [63:0] zext_ln103_fu_98_p1;
wire    ap_block_pp0_stage0;
reg   [9:0] i_1_fu_36;
wire   [9:0] add_ln103_fu_104_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i;
reg    layer1_activations_ce1_local;
reg    layer1_activations_we0_local;
wire   [31:0] add_ln106_fu_120_p2;
reg    layer1_activations_ce0_local;
reg    layer1_activations_2_ce1_local;
reg    layer1_activations_2_we0_local;
wire   [31:0] add_ln106_1_fu_132_p2;
reg    layer1_activations_2_ce0_local;
wire   [8:0] lshr_ln1_fu_88_p4;
wire   [31:0] shl_ln106_fu_115_p2;
wire   [31:0] shl_ln106_1_fu_127_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln103_fu_82_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        layer1_activations_2_addr_reg_156 <= zext_ln103_fu_98_p1;
        layer1_activations_2_addr_reg_156_pp0_iter1_reg <= layer1_activations_2_addr_reg_156;
        layer1_activations_addr_reg_150 <= zext_ln103_fu_98_p1;
...
always @ (*) begin
    if (((icmp_ln103_fu_82_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln103_fu_104_p2 = (ap_sig_allocacmp_i + 10'd2);

assign add_ln106_1_fu_132_p2 = ($signed(shl_ln106_1_fu_127_p2) + $signed(32'd4294766592));

assign add_ln106_fu_120_p2 = ($signed(shl_ln106_fu_115_p2) + $signed(32'd4294766592));
...
assign icmp_ln103_fu_82_p2 = ((ap_sig_allocacmp_i < 10'd784) ? 1'b1 : 1'b0);

assign layer1_activations_2_address0 = layer1_activations_2_addr_reg_156_pp0_iter1_reg;

assign layer1_activations_2_address1 = zext_ln103_fu_98_p1;
...
assign layer1_activations_2_d0 = add_ln106_1_fu_132_p2;

assign layer1_activations_2_we0 = layer1_activations_2_we0_local;

assign layer1_activations_address0 = layer1_activations_addr_reg_150_pp0_iter1_reg;

assign layer1_activations_address1 = zext_ln103_fu_98_p1;

assign layer1_activations_ce0 = layer1_activations_ce0_local;

assign layer1_activations_ce1 = layer1_activations_ce1_local;

assign layer1_activations_d0 = add_ln106_fu_120_p2;

assign layer1_activations_we0 = layer1_activations_we0_local;

assign lshr_ln1_fu_88_p4 = {{ap_sig_allocacmp_i[9:1]}};

assign shl_ln106_1_fu_127_p2 = layer1_activations_2_load_reg_167 << 32'd1;

assign shl_ln106_fu_115_p2 = layer1_activations_load_reg_162 << 32'd1;

assign zext_ln103_fu_98_p1 = lshr_ln1_fu_88_p4;

endmodule //feedforward_feedforward_Pipeline_VITIS_LOOP_103_2
