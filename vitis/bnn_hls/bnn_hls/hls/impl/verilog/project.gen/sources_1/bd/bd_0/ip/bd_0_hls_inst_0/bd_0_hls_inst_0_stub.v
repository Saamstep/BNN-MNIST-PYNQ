...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,feedforward,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,feedforward,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=feedforward,x_ipVersion=1.0,x_ipCoreRevision=2114126139,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=4,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
